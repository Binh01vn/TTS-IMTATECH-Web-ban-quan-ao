...
class UpdateProductValid extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            // tên và mã sản phẩm
            'product-name' => ['required', 'min:5', 'max:255', Rule::unique('products', 'name')->ignore($this->route('product'))],
            // giá sản phẩm
            ...
            'product-avatar' => ['nullable', 'image', 'max:5120'],
        ];
    }
