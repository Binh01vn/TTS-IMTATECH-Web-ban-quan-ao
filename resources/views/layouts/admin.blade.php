...
<head>
    ...
    <!-- ===============================================--><!--    Stylesheets--><!-- ===============================================-->
    @include('layouts.assets.admin.assets.link-head')
    @include('layouts.assets.admin.assets.script-head')
</head>
...
<body>
    ...
    <main class="main" id="top">
        <div class="container" data-layout="container">
            @include('layouts.assets.admin.assets.script-main-content')
            @include('layouts.assets.admin.nav.nav-toggle-double-top')
            @include('layouts.assets.admin.nav.nav-toggle-combo-vertical')
            @include('layouts.assets.admin.nav.nav-toggle-top')
            <div class="content">
                @include('layouts.assets.admin.nav.nav-content-combo-vertical')
                @include('layouts.assets.admin.nav.nav-content-combo')
                <script>
                ...
                @yield('contents')
                @include('layouts.assets.admin.footer.footer')
            </div>
            @include('layouts.assets.admin.footer.authentication-modal')
        </div>
    </main>
    <!-- ===============================================--><!--    End of Main Content--><!-- ===============================================-->
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
            ...
            <div class="z-1 py-1">
                <div class="d-flex justify-content-between align-items-center mb-1">
                    <h5 class="text-white mb-0 me-2">
                        <span class="fas fa-palette me-2 fs-9"></span>Tùy biến giao diện
                    </h5>
                    <button class="btn btn-primary btn-sm rounded-pill mt-0 mb-0" data-theme-control="reset"
                        style="font-size:12px">
                        <span class="fas fa-redo-alt me-1" data-fa-transform="shrink-3"></span>Đặt lại
                    </button>
                </div>
                <p class="mb-0 fs-10 text-white opacity-75">Tùy chỉnh giao diện theo phong cách của riêng bạn</p>
            </div>
        ...
        <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
            <h5 class="fs-9">Bảng màu</h5>
            <p class="fs-10">Chọn chế độ màu hoàn hảo cho ứng dụng của bạn.</p>
                ...
                <div class="row gx-2">
                    <div class="col-4">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherLight">
                            ...
                            <span class="label-text">Sáng</span>
                        </label>
                    </div>
                    <div class="col-4"><input class="btn-check" id="themeSwitcherDark" name="theme-color"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherDark"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    ...
                                    alt="" /></span><span class="label-text">Tối</span></label></div>
                    <div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color"
                            ...
                            class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherAuto"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    ...
                                    alt="" /></span><span class="label-text">Tự động</span></label></div>
                </div>
            </div>
            <hr />
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        ...
                        alt="" />
                    <div class="flex-1">
                        <h5 class="fs-9">Chế độ từ phải qua trái (RTL)</h5>
                        <p class="fs-10 mb-0">Được đề xuất cho các ngôn ngữ như tiếng Ả Rập, tiếng Do Thái hoặc các
                            ngôn ngữ RTL khác.</p>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src="{{ asset('theme/admin/assets/img/icons/arrows-h.svg') }}" width="20"
                        alt="" />
                    <div class="flex-1">
                        <h5 class="fs-9">Chế độ toàn màn hình</h5>
                        <p class="fs-10 mb-0">Chuyển đổi hệ thống bố trí container.</p>
                    </div>
                </div>
                <div class="form-check form-switch">
            ...
            <div class="d-flex align-items-start"><img class="me-2"
                ...
                <div class="flex-1">
                    <h5 class="fs-9 d-flex align-items-center">Vị trí điều hướng</h5>
                    <p class="fs-10 mb-2">Chọn một hệ thống điều hướng phù hợp cho ứng dụng web của bạn.</p>
                    <div><select class="form-select form-select-sm" aria-label="Navbar position"
                            data-theme-control="navbarPosition">
                            <option value="vertical">Thanh dọc</option>
                            <option value="top">Thanh ngang trên</option>
                            <option value="combo">Thanh Kết hợp</option>
                            <option value="double-top">Thanh ngang đôi</option>
                        </select></div>
                </div>
            </div>
            <hr />
            <h5 class="fs-9 d-flex align-items-center">Kiểu thanh điều hướng đứng</h5>
            <p class="fs-10 mb-0">Chuyển đổi giữa các kiểu cho thanh điều hướng dọc của bạn.</p>
            <div class="btn-group d-block w-100 btn-group-navbar-style">
                <div class="row gx-2">
                    <div class="col-6"><input class="btn-check" id="navbar-style-transparent" type="radio"
                            ...
                            class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-transparent"> <img
                                ...
                                src="{{ asset('theme/admin/assets/img/generic/default.png') }}"
                                alt="" /><span class="label-text">Trong suốt</span></label></div>
                    <div class="col-6"><input class="btn-check" id="navbar-style-inverted" type="radio"
                            ...
                            class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-inverted"> <img
                                class="img-fluid img-prototype"
                                src="{{ asset('theme/admin/assets/img/generic/inverted.png') }}"
                                alt="" /><span class="label-text">Đảo màu</span></label></div>
                    <div class="col-6"><input class="btn-check" id="navbar-style-card" type="radio"
                            ...
                            class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-card"> <img
                                ...
                                class="label-text">Thẻ</span></label></div>
                    <div class="col-6"><input class="btn-check" id="navbar-style-vibrant" type="radio"
                            ...
                            class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-vibrant"> <img
                                class="img-fluid img-prototype"
                                src="{{ asset('theme/admin/assets/img/generic/vibrant.png') }}"
                                alt="" /><span class="label-text">Sôi động</span></label></div>
                </div>
            </div>
        </div>
    </div>
    <a class="card setting-toggle" href="#settings-offcanvas" data-bs-toggle="offcanvas">
        <div class="card-body d-flex align-items-center py-md-2 px-2 py-1">
            <div class="bg-primary-subtle position-relative rounded-start" style="height:34px;width:28px">
                ...
                class="text-uppercase text-primary fw-bold bg-primary-subtle py-2 pe-2 ps-1 rounded-end">tùy chỉnh</small>
        </div>
    </a>

    <!-- ===============================================--><!--    JavaScripts--><!-- ===============================================-->
    @include('layouts.assets.admin.assets.link-js')
</body>
