        ...
        <div class="row align-items-center gx-4">
            ...
            <div class="col-12 col-xl order-4 order-xl-0">
                <div class="input-group flex-nowrap pb-3 pb-xl-0">
                    ...
                    <button class="btn btn-dark btn-ecomm border-3" type="button">Tìm kiếm</button>
                </div>
            </div>
                            ...
                            <li class="nav-item dropdown dropdown-large">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" style="width: 450px;">
                                        <a href="javascript:;">
                                            <div class="cart-header">
                                                <p class='cart-header-title mb-0'>{{ count(session('cart')) }} Sản phẩm</p>
                                                <p class="cart-header-clear ms-auto mb-0">Xem giỏ hàng</p>
                                            </div>
                                        </a>
                                        <div class="cart-list">
                                        ...
                                        <div class="d-grid p-3 border-top">
                                            <a href="{{ route('cart.shopCart') }}" class="btn btn-dark btn-ecomm">
                                                Xem giỏ hàng
                                            </a>
                                        </div>
                                    </div>
                                @else
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="javascript:;">
                                            <div class="cart-header">
                                                <p class='cart-header-title mb-0'>0 Sản phẩm</p>
                                                <p class="cart-header-clear ms-auto mb-0">Xem giỏ hàng</p>
                                            </div>
                                        </a>
                                        <div class="cart-list">
                                        ...
                                        <div class="d-grid p-3 border-top">
                                            <a href="javascript:;" class="btn btn-dark btn-ecomm">MUA SẮM NGAY</a>
                                        </div>
                                    </div>
                                @endif
                            </li>
