        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <a href="{{ route('admin.products.restoreAll') }}" class="btn btn-success">Khôi phục tất cả</a>
                </div>
                                    ...
                                    <div class="dropstart font-sans-serif position-static d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-2"
                                            ...
                                            <a class="dropdown-item text-center"
                                                href="{{ route('admin.products.restoreProduct', $item->id) }}">
                                                <span class="btn btn-success">Khôi phục</span>
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <form action="{{ route('admin.products.forceDelProduct', $item->id) }}"
                                                method="post" style="text-align: center;">
                                                @csrf
                                                @method('DELETE')
                                                <button class="btn btn-danger"
                                                    onclick="return confirm('Có chắc chắn muốn xóa không, nếu xóa sản phẩm này thì tất cả các dữ liệu liên quan đến sản phẩm cũng bị xóa theo?')"
