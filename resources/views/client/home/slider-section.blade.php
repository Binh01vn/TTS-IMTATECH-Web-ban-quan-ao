        ...
        <div class="banner-slider owl-carousel owl-theme">
            <div class="item">
                <div class="position-relative">
                    ...
                    <a href="javascript:;">
                        <img src="{{ asset('theme/client/images/banners/01.png') }}" class="img-fluid" alt="...">
                    </a>
                </div>
            </div>
            <div class="item">
                <div class="position-relative">
                    ...
                    <a href="javascript:;">
                        <img src="{{ asset('theme/client/images/banners/02.png') }}" class="img-fluid" alt="...">
                    </a>
                </div>
            </div>
            <div class="item">
                <div class="position-relative">
                    ...
                    <a href="javascript:;">
                        <img src="{{ asset('theme/client/images/banners/04.png') }}" class="img-fluid" alt="...">
                    </a>
                </div>
            </div>
        </div>
