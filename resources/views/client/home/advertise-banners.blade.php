            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-4 g-4">
                <div class="col d-flex">
                    <div class="card rounded-0 w-100 border-0 shadow-none">
                        <img src="{{ asset('theme/client/images/promo/04.png') }}" class="img-fluid" alt="...">
                ...
                <div class="col d-flex">
                    <div class="card rounded-0 w-100 border-0 shadow-none">
                        <img src="{{ asset('theme/client/images/promo/08.png') }}" class="img-fluid" alt="...">
                ...
                <div class="col d-flex">
                    <div class="card rounded-0 w-100 border-0 shadow-none">
                        <img src="{{ asset('theme/client/images/promo/06.png') }}" class="img-fluid h-100"
                            alt="...">
                ...
                <div class="col d-flex">
                    <div class="card rounded-0 w-100 border-0 shadow-none">
                        ...
                        <img src="{{ asset('theme/client/images/promo/07.png') }}" class="img-fluid" alt="...">
                        <div class="card-body text-center">
