                        ...
                        <div class="row">
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('theme/client/assets/images/product-image/1.jpg') }}"
                                                alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('theme/client/assets/images/product-image/2.jpg') }}"
                                                alt="Product" />
                                        </a>
                                        <span class="badges">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('theme/client/assets/images/product-image/3.jpg') }}"
                                                alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('theme/client/assets/images/product-image/4.jpg') }}"
                                                alt="Product" />
                                        </a>
                                        <span class="badges">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('theme/client/assets/images/product-image/5.jpg') }}"
                                                alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('theme/client/assets/images/product-image/6.jpg') }}"
                                                alt="Product" />
                                        </a>
                                        <span class="badges">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('theme/client/assets/images/product-image/7.jpg') }}"
                                                alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('theme/client/assets/images/product-image/8.jpg') }}"
                                                alt="Product" />
                                        </a>
                                        <span class="badges">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-md-30px mb-lm-30px"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('theme/client/assets/images/product-image/2.jpg') }}"
                                                alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('theme/client/assets/images/product-image/10.jpg') }}"
                                                alt="Product" />
                                        </a>
                                        <span class="badges">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6  mb-md-30px mb-lm-30px"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('theme/client/assets/images/product-image/4.jpg') }}"
                                                alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('theme/client/assets/images/product-image/12.jpg') }}"
                                                alt="Product" />
                                        </a>
                                        <span class="badges">
                                        </span>
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-es-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('theme/client/assets/images/product-image/6.jpg') }}"
                                                alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('theme/client/assets/images/product-image/14.jpg') }}"
                                                alt="Product" />
                                        </a>
                                        <span class="badges">
                                        </span>
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 " data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('theme/client/assets/images/product-image/8.jpg') }}"
                                                alt="Product" />
                                            <img class="hover-image"
                                                src="{{ asset('theme/client/assets/images/product-image/16.jpg') }}"
                                                alt="Product" />
                                        </a>
                                        <span class="badges">
                                            <span class="new">Sale</span>
