            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="testi-inner">
                        ...
                        <div class="testi-author">
                            <div class="author-img">
                                <img src="{{ asset('theme/client/assets/images/testimonial-image/1.png') }}"
                                    alt="">
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="testi-inner">
                        ...
                        <div class="testi-author">
                            <div class="author-img">
                                <img src="{{ asset('theme/client/assets/images/testimonial-image/2.png') }}"
                                    alt="">
                            </div>
                            <div class="author-name">
                ...
                <div class="swiper-slide">
                    <div class="testi-inner">
                        ...
                        <div class="testi-author">
                            <div class="author-img">
                                <img src="{{ asset('theme/client/assets/images/testimonial-image/3.png') }}"
                                    alt="">
                            </div>
                            <div class="author-name">
