                        ...
                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 align-self-center sm-center-view">
                            <div class="hero-slide-content slider-animated-1">
                                ...
                                <a href="shop-left-sidebar.html" class="btn btn-lg btn-primary btn-hover-dark">
                                    Shop Now <i class="fa fa-shopping-basket ml-15px" aria-hidden="true"></i></a>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{ asset('theme/client/assets/images/slider-image/slider-1.png') }}"
                                        alt=""/>
                                </div>
                                <div class="display-wrapper">
                                    ...
                                    <div class="image-side">
                                        <img src="{{ asset('theme/client/assets/images/slider-image/display-image.png') }}"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container align-self-center">
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{ asset('theme/client/assets/images/slider-image/slider-2.png') }}"
                                        alt="" />
                                </div>
                                <div class="display-wrapper">
                                    <div class="content-side">
