            ...
            <div class="row">
                <div class="col-auto align-self-center">
                    <div class="header-logo">
                        <a href="index.html">
                            <img src="{{ asset('theme/client/assets/images/logo/logo.png') }}" alt="Site Logo" />
                        </a>
                    </div>
                </div>
                                            ...
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html">
                                                    <img class="img-responsive w-100"
                                                        src="{{ asset('theme/client/assets/images/banner/7.jpg') }}"
                                                        alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html">
                                                    <img class="img-responsive w-100"
                                                        src="{{ asset('theme/client/assets/images/banner/8.jpg') }}"
                                                        alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html">
                                                    <img class="img-responsive w-100"
                                                        src="{{ asset('theme/client/assets/images/banner/9.jpg') }}"
                                                        alt="">
                                                </a>
                                            </li>
                                        </ul>
